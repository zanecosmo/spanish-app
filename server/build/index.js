...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent(); // to create a database pool for queries
                ...
                (0, word_crud_router_1.enableCRUDRoutes)(app, database_1.database); // enable admin router for CRUD word operations
